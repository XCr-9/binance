...
[![Build Status](https://travis-ci.org/XCr-9/binance.svg?branch=master)](https://travis-ci.org/XCr-9/binance)
[![GoDoc](https://godoc.org/github.com/XCr-9/binance?status.svg)](https://godoc.org/github.com/XCr-9/binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/XCr-9/binance)](https://goreportcard.com/report/github.com/XCr-9/binance)
[![codecov](https://codecov.io/gh/XCr-9/binance/branch/master/graph/badge.svg)](https://codecov.io/gh/XCr-9/binance)
...
```shell
go get github.com/XCr-9/binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/XCr-9/binance/v1
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/XCr-9/binance) for full references.
...
```go
import (
    "github.com/XCr-9/binance/v2/futures"
)
...
```go
import (
    "github.com/XCr-9/binance/v2/delivery"
)
